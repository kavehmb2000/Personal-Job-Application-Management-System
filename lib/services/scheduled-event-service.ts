...
export class ScheduledEventService {
  ...
  async getById(
    ...
    return this.repository.getById(ownerId, opportunityId, scheduledEventId);
  }
  ...
  async delete(
    ...
    return this.repository.delete(ownerId, opportunityId, scheduledEventId);
  }
  ...
  async removeContact(
    ...
    return this.repository.removeContact(
      ownerId,
      opportunityId,
      scheduledEventId,
      contactId,
