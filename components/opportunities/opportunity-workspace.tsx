...
import { MobileEntry } from "@/components/opportunities/mobile-entry";
  ...
  return (
    ...
    >
      ...
      <MobileEntry
        ...
        currentStatus={currentState.key}
      />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section
          aria-labelledby="scheduled-event-title"
          className="rounded-lg border p-4 lg:col-span-2"
        >
        ...
        <section
          aria-labelledby="scheduled-events-title"
          className="rounded-lg border p-4 lg:col-span-2"
        >
