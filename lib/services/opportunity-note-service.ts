...
export class OpportunityNoteService {
  constructor(private readonly repository: OpportunityNoteRepository) {}
  ...
  async getById(ownerId: string, opportunityId: string, noteId: string) {
    return this.repository.getById(ownerId, opportunityId, noteId);
  }
  ...
  async update(
    ...
    return this.repository.update(ownerId, opportunityId, noteId, input);
  }
}
